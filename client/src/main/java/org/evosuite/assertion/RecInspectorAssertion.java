...
public class RecInspectorAssertion extends Assertion{
    ...
    protected RecComposeInspector inspector;
     ...
     */
    public RecComposeInspector getInspector() {
        return inspector;
    }
    ...
    public Assertion copy(TestCase newTestCase, int offset) {
        RecInspectorAssertion s = new RecInspectorAssertion();
    ...
    public String getCode() {
        if (value == null) {
            return "assertNull(" + source.getName() + "." + inspector.getMethodCalls()
                    + "());";
        } else if (value.getClass().equals(Long.class)) {
            return "assertEquals(" + NumberFormatter.getNumberString(value) + ", "
                    + source.getName() + "." + inspector.getMethodCalls() + "());";
        } else if (value.getClass().equals(Float.class)) {
            return "assertEquals(" + NumberFormatter.getNumberString(value) + ", "
                    + source.getName() + "." + inspector.getMethodCalls() + "(), 0.01F);";
        } else if (value.getClass().equals(Double.class)) {
            return "assertEquals(" + NumberFormatter.getNumberString(value) + ", "
                    + source.getName() + "." + inspector.getMethodCalls() + "(), 0.01D);";
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RecInspectorAssertion other = (RecInspectorAssertion) obj;
        if (inspector == null) {
